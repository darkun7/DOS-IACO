...
The archive is made of 7 files : 
	...
	* the file "pure_spectra_metadata_with-species-name.csv"
		- identical to pure_spectra_metadata.csv file with species names specified
	* the file "pure_spectra_taxonomy_with-nodes-name.txt"
		- identical to pure_spectra_taxonomy.txt file with nodes names specified
	* the file "pure_spectra_taxonomy_with-nodes-name.pdf"
		- identical to pure_spectra_taxonomy.pdf file with nodes names specified
	* the file "mixed_spectra_metadata_with-species-name.csv"
		- identical to mixed_spectra_metadata.csv with species names specified
